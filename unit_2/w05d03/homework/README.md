...
> **STRETCH GOAL!** Make a middleware route that does all of the above. It should calculate the bankAccount total and store it in a variable called `req.sum` that you can now access in all routes, including the index route where you should display the total on the `index.ejs` page. 
