...
Yesterday, you designed a calculator for the browser using HTML/CSS. Today, your task is to add the functionality to make it calculate!
...
1. In yesterday's `student_labs` folder you created a `calculator` directory with the needed HTML/CSS/JS files. Just feel free to continue working in there! 

1. If you did not finish the styling, don't worry about it. Just focus on getting the functionality working
